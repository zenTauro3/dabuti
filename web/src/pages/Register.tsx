            ...
            <div className="bg-white p-8 rounded shadow-md w-96 text-center">
                ...
                <form className="mb-4 space-y-4" onSubmit={handleRegister}>
                    ...
                    <button disabled={state}
                        className={`flex justify-center disabled:opacity-75 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg w-full transition duration-300 ease-in-out ${state ? 'cursor-not-allowed' : 'transform hover:scale-105'}`}
                    >{loading ? miniLoader() : 'Register'}</button>
